...
namespace Drupal\helfi_node_news_article\Hook;
...
class ChangedAtFieldHooks {
   ...
   *
   * Opts news_article nodes into the reusable 'changed_at' field provided by
  ...
  public static function changedAtFieldBundles(): array {
    return [
      new ChangedAtFieldBundle('node', 'news_article'),
    ];
  }
