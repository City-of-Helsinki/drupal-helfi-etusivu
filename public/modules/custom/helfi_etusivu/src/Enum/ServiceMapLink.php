...
enum ServiceMapLink {
  ...
  public function link(): string {
    return match($this) {
      ServiceMapLink::ROADWORK_EVENTS => 'eAUWMm',
      ServiceMapLink::CITYBIKE_STATIONS_STANDS => 'eAU1d6',
      ServiceMapLink::STREET_PARK_PROJECTS => 'eBcsC6',
      ServiceMapLink::PLANS_IN_PROCESS => 'eATpBc',
    };
  }
}
